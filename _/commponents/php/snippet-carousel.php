	...
	<div id="myCarousel" class="carousel slide hidden-xs">
		...
		<div class="carousel-inner">
			<div class="item active"><img src="images/carousel/seattle_skyline.jpg" alt="Photo of Seattle Skyline">
			...
			<div class="item"><img src="images/carousel/painting_workshop.jpg" alt="Photo of"></div>
			<div class="item"><img src="images/carousel/pottery_workshop.jpg" alt="Photo of"></div>
			<div class="item"><img src="images/carousel/jewelry_workshop.jpg" alt="Photo of"></div>
			<div class="item"><img src="images/carousel/quicksketch_workshop.jpg" alt="Photo of"></div>
		</div><!--carousel-inner-->
